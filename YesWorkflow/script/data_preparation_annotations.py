...
# In[304]:
"""
@begin clean_words_clusters_job_title @desc Cleans strings with regex, mappings and replacements
@in data_dropped_salary_job_ctx
@param word @AS word_values
@out cw_clusters_job_title
@end clean_words_clusters_job_title
"""
"""
@begin create_clusters_job_title @desc Creates a 'cluster_job_title' from column 'job_title' unique values
@in data_dropped_salary_job_ctx
@in cw_clusters_job_title
@param possibilities @AS job_title_possibilities
@param cutoff @AS job_title_cutoff
...
# In[306]:
"""
@begin replace_job_title @desc Replaces the 'job_title' column values with cluster data values
@in data_dropped_salary_job_ctx
@in clusters_job_title
@out data_replaced_job_title_clean
@end replace_job_title
"""
...
"""
@begin clean_words_clusters_job_title_second @desc Cleans strings with regex, mappings and replacements
@in data_replaced_job_title_clean
@param word @AS word_values
@out cw_clusters_job_title_second
@end clean_words_clusters_job_title_second
"""
"""
...
@in data_replaced_job_title_clean
@in cw_clusters_job_title_second
@param possibilities @AS job_title_possibilities
@param cutoff @AS job_title_cutoff
@out clusters_job_title_second
@end create_clusters_job_title_second
"""
...
"""
@begin replace_job_title_clean @desc Replaces the 'job_title_clean' column values with the second clusters_job_title
@in data_replaced_job_title_clean
@in clusters_job_title_second
@out data_replaced_job_title_clean_second
@end replace_job_title_clean
"""
...
# In[314]:
"""
@begin clean_words_clusters_job_title_third @desc Cleans strings with regex, mappings and replacements
@in data_replaced_job_title_clean_second
@param word @AS word_values
@out cw_clusters_job_title_third
@end clean_words_clusters_job_title_third
"""
"""
@begin create_job_title_clean_third @desc Creates a cluster based on possibilities for the second job_title_clean column unique values
@in data_replaced_job_title_clean_second
@in cw_clusters_job_title_third
@param possibilities @AS job_title_possibilities
@param cutoff @AS job_title_cutoff
@out clusters_job_title_third
...
"""
@begin replace_job_title_clean_third @desc Replaces the 'job_title_clean' from column 'job_title_clean' with second word possibilities word clean and cluster
@in data_replaced_job_title_clean_second
@in clusters_job_title_third
@out data_replaced_job_title_clean_third
@end replace_job_title_clean_third
"""
data['job_title_clean'].replace(clusters_job_title, inplace=True)
...
@out clusters_industry
@end create_clusters_industry
"""
...
"""
@begin replace_industry_clean @desc Creates an 'industry_clean' column from 'industry' column unique values clustering
@in data_replaced_job_title_clean_third
@in clusters_industry
@out data_plus_industry_clean
@end replace_industry_clean
"""
data['industry_clean'] = data['industry'].replace(clusters_industry)

# In[364]:
"""
@begin clean_words_industry_second @desc Cleans industry string using regex, mappings and replacements
@in data_plus_industry_clean
@param word @AS word_values
@out cleaned_words_industry_second
@end clean_words_industry_second
"""
"""
@begin create_clusters_industry_second @desc Creates a second industry cluster based on the 'industry_clean' column unique values
@in data_plus_industry_clean
@in cleaned_words_industry_second
@param possibilities @AS industry_possibilities
@param cutoff @AS industry_cutoff
@out clusters_industry_second
@end create_clusters_industry_second
"""
...
# In[365]:
"""
@begin replace_industry_clean_second @desc Replaces 'industry_clean' column values based on industry_clean cluster
@in data_plus_industry_clean
@in clusters_industry_second
@out data_industry_clean_second
@end replace_industry_clean_second
"""
data['industry_clean'].replace(clusters_industry, inplace=True)

# In[366]:
"""
@begin clean_words_industry_third @desc Cleans industry string using regex, mappings and replacements
@in data_industry_clean_second
@param word @AS word_values
@out cleaned_words_industry_third
@end clean_words_industry_third
"""
"""
@begin create_clusters_industry_third @desc Creates a third industry cluster based on the 'industry_clean' column unique values
@in data_industry_clean_second
@in cleaned_words_industry_third
@param possibilities @AS industry_possibilities
@param cutoff @AS industry_cutoff
@out clusters_industry_third
@end create_clusters_industry_third
"""
possibilities = list([str(x) for x in data['industry_clean'].unique()])
...
# In[367]:
"""
@begin replace_industry_clean_third @desc Replaces 'industry_clean' column with 'clusters_industry_third' clustered values
@in data_industry_clean_second
@in clusters_industry_third
@out data_industry_clean_third
@end replace_industry_clean_third
"""
data['industry_clean'].replace(clusters_industry, inplace=True)

# In[376]:
"""
@begin clean_words_industry_fourth @desc Cleans industry string using regex, mappings and replacements
@in data_industry_clean_third
@param word @AS word_values
@out cleaned_words_industry_fourth
@end clean_words_industry_fourth
"""
"""
@begin create_clusters_industry_fourth @desc Creates a fourth industry cluster based on the 'industry_clean' column unique values
@in data_industry_clean_third
@param possibilities @AS industry_possibilities
@param cutoff @AS industry_cutoff
@out clusters_industry_fourth
@end create_clusters_industry_fourth
"""
possibilities = list([str(x) for x in data['industry_clean'].unique()])
...
# In[379]:
"""
@begin replace_industry_clean_fourth @desc Replaces 'industry_clean' column with 'clusters_industry_fourth' clustered values
@in data_industry_clean_third
@in clusters_industry_fourth
@out data_industry_clean_fourth
@end replace_industry_clean_fourth
"""
data['industry_clean'].replace(clusters_industry, inplace=True)
...
"""
"""
@begin create_clusters_industry_fifth @desc Creates a fifth industry cluster based on the 'industry_clean' column unique values
@in data_industry_clean_fourth
@in cleaned_words_industry_fourth
@param possibilities @AS industry_possibilities
@param cutoff @AS industry_cutoff
@out clusters_industry_fifth
@end create_clusters_industry_fifth
"""
possibilities = list([str(x) for x in data['industry_clean'].unique()])
...
# In[386]:
"""
@begin replace_industry_clean_fifth @desc Replaces 'industry_clean' column with 'clusters_industry_fifth' clustered values
@in data_industry_clean_fourth
@in clusters_industry_fifth
@out data_industry_clean_fifth
@end replace_industry_clean_fifth
"""
data['industry_clean'].replace(clusters_industry, inplace=True)
